...
router.post('/register', authLimiter, requireGuest, registerValidationRules, authController.postRegister);

// Login routes
router.get('/login', requireGuest, authController.getLogin);
router.post('/login', authLimiter, requireGuest, loginValidationRules, authController.postLogin);
